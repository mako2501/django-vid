...
SECRET_KEY = 'django-insecure-r1jk*)0@)x78#ru717vm(_kju23rgi!*%95d#r0k8ru%5t77jp' #niech sobie tutaj jest ;)
...
INSTALLED_APPS = [
    ...
    'rest_framework', #musi zostac dodane
    'api' #kazdą apkę należy tutaj dodać
]
